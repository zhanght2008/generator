...
public class XmlConstants {
    ...
    public static final String mybatis3_url_prefix="http://localhost:8080/d/";
//    public static final String mybatis3_url_prefix="http://mybatis.org/dtd/";
    ...
    public static final String MYBATIS3_MAPPER_SYSTEM_ID =  mybatis3_url_prefix+"mybatis-3-mapper.dtd"; //$NON-NLS-1$

    public static final String MYBATIS3_MAPPER_PUBLIC_ID = "-//mybatis.org//DTD Mapper 3.0//EN"; //$NON-NLS-1$

    public static final String MYBATIS3_MAPPER_CONFIG_SYSTEM_ID = mybatis3_url_prefix+"mybatis-3-config.dtd"; //$NON-NLS-1$
    ...
    public static final String MYBATIS_GENERATOR_CONFIG_SYSTEM_ID = mybatis3_url_prefix+"mybatis-generator-config_1_0.dtd"; //$NON-NLS-1$
